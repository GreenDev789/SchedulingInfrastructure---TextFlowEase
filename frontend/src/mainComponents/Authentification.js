  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '50px', flexDirection: 'column' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
        ...
        <p style={{ textAlign: 'center', marginBottom: '10px', fontFamily: 'Euclid Circular A Light, sans-serif', fontWeight: 'normal' }}>TextFlowEase delivers the answers found in your PDFs that you need, when you need them.</p>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '50px' }}>
        ...
        <input type="text" value={value} onChange={handleChange} style={{ fontFamily: 'Euclid Circular A Light, sans-serif', backgroundColor: errorMessage ? '#FFE6E6' : 'green', boxShadow: "0px 4px 4px rgba(0, 0, 0, 0.25)", width: '40%', height: '30px', borderRadius: '15px', border: '0.5px solid gray', padding: '10px' }} placeholder="Enter your text here" />
